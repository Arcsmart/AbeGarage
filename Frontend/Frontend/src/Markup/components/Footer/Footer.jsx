...
<footer class="main-footer">
          ...
          <div class="row no-gutters">
                    ...
                    <div class="info-inner">
                              ...
                              <div class="text">Email us : <br/> <a
                                        href="mailto:contact.contact@autorex.com">arc@garge.com</a></div>
                              </div>
                    </div>
                    </div>
          ...
          <div class="copyright-text">© Copyright <a href="#">Arcgarage</a> 2025 . All right reserved.</div>
          <div class="text">Created by <a href="#">Tesfaye</a></div>
          </div>
          </div>
</footer>
{/* <!--End Main Footer--> */}
